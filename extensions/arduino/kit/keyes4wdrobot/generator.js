...
function addGenerator (Blockly) {
    ...
    Blockly.Arduino.KS_micros = function() {
      ...
      Blockly.Arduino.robot_forward = function (block) {
        ...
        const valL = Blockly.Arduino.valueToCode(block, 'SPEED_L', Blockly.Arduino.ORDER_ATOMIC) || '200';
        const valR = Blockly.Arduino.valueToCode(block, 'SPEED_R', Blockly.Arduino.ORDER_ATOMIC) || '200';

        Blockly.Arduino.setups_[`robot_s`] = 'pinMode(2, OUTPUT);\n  pinMode(6, OUTPUT);\n  pinMode(4, OUTPUT);\n  pinMode(5, OUTPUT);\n';
       
        // 前进：D2=HIGH(电机A正转)，D6=速度R，D4=HIGH(电机B正转)，D5=速度L
    ...
    Blockly.Arduino.robot_back = function (block) {
        ...
        // 后退：D2=LOW(电机A反转)，D6=速度R，D4=LOW(电机B反转)，D5=速度L
    ...
    Blockly.Arduino.robot_left = function (block) {
        ...
        // 左旋转：D2=LOW(电机A反转)，D6=速度R，D4=HIGH(电机B正转)，D5=速度L
        return 'digitalWrite(2,LOW);\nanalogWrite(6,'+valR+');\ndigitalWrite(4,HIGH);\nanalogWrite(5,'+valL+');\n';
    };
    ...
    Blockly.Arduino.robot_right = function (block) {
        ...
        // 右旋转：D2=HIGH(电机A正转)，D6=速度R，D4=LOW(电机B反转)，D5=速度L
        return 'digitalWrite(2,HIGH);\nanalogWrite(6,'+valR+');\ndigitalWrite(4,LOW);\nanalogWrite(5,'+valL+');\n';
    };
