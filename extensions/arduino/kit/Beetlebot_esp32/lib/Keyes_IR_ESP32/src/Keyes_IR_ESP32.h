...
#ifndef _KEYES_IR_ESP32_h
#define _KEYES_IR_ESP32_h
...
class Keyes_ESP32_IR_Recv
{
public:
	Keyes_ESP32_IR_Recv(uint8_t pin);
	virtual ~Keyes_ESP32_IR_Recv(void);
