...
// 控制 ESP32 运行核心
    Blockly.Arduino.controls_runnig_core = function () {
        ...
        var value_length = Blockly.Arduino.valueToCode(this, 'length', Blockly.Arduino.ORDER_ATOMIC) || '0';
        ...
        // 定义任务函数
        Blockly.Arduino.definitions_['esp32_task_' + task] = 
            'void task_' + task + '(void * pvParameters) {\n' +
            '    for (;;) {\n' +
            '        ' + branch1 + '\n' +
            '        vTaskDelay(1);\n' +
            '    }\n' +
    ...
    Blockly.Arduino.ks_servo_angle = function (block) {
        ...
        '  return servo_angle;\n'+
        '}\n';
        Blockly.Arduino.setups_[`servo_init_${pin}`] = 'ledcAttachChannel('+pin+',50,10,3);\n';
